<script lang="ts">
    import type ICategoria from "src/interfaces/ICategoria";
...
<div class="categoria-container">
    <img class="categoria-imagem" src="/icones/categorias_ingredientes/{categoria.imagem}" alt={categoria.nome}>
